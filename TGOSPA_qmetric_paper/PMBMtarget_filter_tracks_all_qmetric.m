...
save(['PMBM_qmetric_all_pd',int2str(100*p_d),'_R',int2str(R(1,1)),'_clut',int2str(l_clutter),'_Nhyp_max',int2str(Nhyp_max),'_rho',int2str(10*rho_qmetric)])
...
if(plot_figures)
    ...
    %Q-metric score
    figure(6)
    plot(1:Nsteps,score_TGOSPAq_t_tot/Nmc, 'b','Linewidth',1.3)
    xlabel('Time step')
    ylabel('Score')
    grid on
    legend('T-GOSPA q-metric score')
