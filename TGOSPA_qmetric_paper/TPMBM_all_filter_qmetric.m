...
%mixture (PMBM) filter.
%K. Granström, L. Svensson, Y. Xia, J. Williams and Á. F. García-Fernández,
%"Poisson Multi-Bernoulli Mixtures for Sets of Trajectories," in IEEE Transactions on Aerospace and Electronic Systems, vol. 61, no. 2, pp. 5178-5194, April 2025.
...
save(['TPMBM_qmetric_pd',int2str(100*p_d),'_R',int2str(R(1,1)),'_clut',int2str(l_clutter),'_Nhyp_max',int2str(Nhyp_max),'_Lscan',int2str(Lscan),'_rho',int2str(10*rho_qmetric)])
