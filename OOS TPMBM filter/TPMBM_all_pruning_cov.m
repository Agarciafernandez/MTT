function filter_upd_pruned=TPMBM_all_pruning_cov(filter_upd, T_pruning,T_pruningPois,Nhyp_max,existence_threshold,T_alive)
...
for i=1:Ntracks
    ...
    filter_upd_pruned.tracks{i}.cov_past(index_remove)=[];
