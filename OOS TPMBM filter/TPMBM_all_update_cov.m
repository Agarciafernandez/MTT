function filter_upd=TPMBM_all_update_cov(filter_pred,z,H,R,p_d,k,gating_threshold,intensity_clutter,Nhyp_max,Lscan,T_alive)

%TPMBM update for all trajectories
%This version contains information on the covariance for hypothesies with
%dead trajectories in the last L-scan window
...
for i=1:Nprev_tracks
    ...
    for j=1:Nhyp_i %We go through all hypotheses
        ...
        if(prob_alive_j>T_alive)
            ...
            filter_upd.tracks{i}.cov_past{j}=filter_pred.tracks{i}.cov_past{j};
