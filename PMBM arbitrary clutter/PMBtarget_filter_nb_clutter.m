% Demo with the implementation of the point-target Poisson multi-Bernoulli (PMB)
...
plot_figures=0; %To plot figures
...
Nhyp_max=5000;  %Maximum number of hypotheses (MBM components)
...
save(['PMB_nb_pd',int2str(100*p_d),'_R',int2str(R(1,1)),'_clut',int2str(l_clutter), '_anb',int2str(a_nb),'_Nhyp_max',int2str(Nhyp_max),'_nb',int2str(nb_indicator),'_est',int2str(type_estimator)])
