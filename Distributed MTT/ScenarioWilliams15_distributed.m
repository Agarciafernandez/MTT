...
hold on
plot(X_truth(1,t_birth(1)),X_truth(3,t_birth(1)),'ob','Linewidth',1.3,'MarkerFaceColor','b')
...
plot(X_truth(5,t_birth(2)),X_truth(7,t_birth(2)),'or','Linewidth',1.3,'MarkerFaceColor','r')
...
plot(X_truth(9,t_birth(3)),X_truth(9,t_birth(3)),'og','Linewidth',1.3,'MarkerFaceColor','g')
...
plot(X_truth(13,t_birth(4)),X_truth(15,t_birth(4)),'oblack','Linewidth',1.3,'MarkerFaceColor','black')
