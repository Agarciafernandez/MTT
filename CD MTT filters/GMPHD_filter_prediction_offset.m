function   [weights_k, means_k,covs_k,Ncom_k,logical_active_k]=GMPHD_filter_prediction_offset(weights_u, means_u,covs_u,Ncom_u,logical_active_u,F,Q,p_s,offset_mean)

%Prediction for the GMPHD filter

%It incorporates an offset for the mean
...
for i=1:Ncom_u
    ...
    mean_i_pred=F*mean_i+offset_mean;
