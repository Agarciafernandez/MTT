...
save(['PMBM_cd_linear_pd',int2str(100*p_d),'_R',int2str(R(1,1)),'_clut',int2str(l_clutter),'_Nhyp_max',int2str(Nhyp_max),'_lambda',int2str(100*lambda),'_mu',int2str(100*mu)])
