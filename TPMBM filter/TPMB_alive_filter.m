%Demo with the Gaussian implementation of the trajectory Poisson multi-Bernoulli (PMB)
%filter described in
...
%MB scenario with best PPP fit to run the TPMB filter
...
%save(['TPMB_alive_pd',int2str(100*p_d),'_R',int2str(R(1,1)),'_clut',int2str(l_clutter),'_Nhyp_max',int2str(Nhyp_max),'_Lscan',int2str(Lscan)])
