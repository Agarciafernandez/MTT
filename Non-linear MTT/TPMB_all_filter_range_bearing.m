...
% (TPMB) filter for the set of all trajectories with VMF direction-of-arrival measurements and
...
% Á. F. García-Fernández, L. Svensson, J. L. Williams, Y. Xia and K. Granström, 
% "Trajectory Poisson Multi-Bernoulli Filters," in IEEE Transactions on Signal Processing, 
% vol. 68, pp. 4933-4945, 2020
...
plot_figures=1; %Flag to plot the figures
...
for i=1:Nmc
    ...
    for k=1:Nsteps
        ...
        %TPMB projection
        filter_upd_pmb=TPMB_all_projection(filter_upd,T_alive,Nx,k,Lscan);
...
save(['TPMB_all_rb_kappa',int2str(kappa),'_R_range',...
