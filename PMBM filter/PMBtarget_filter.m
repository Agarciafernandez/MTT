...
%The projection step as a KLD minimisation with auxiliary varialbes is
%explained here (thought this paper describes this step for PMBs trajectories,
%it is directly applicable to PMBs for target)
