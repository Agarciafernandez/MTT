function filter_upd=TrMBM_all_update(filter_pred,z,H,R,p_d,k,gating_threshold,intensity_clutter,Nhyp_max,Lscan,T_alive)

%TrMBM update for all trajectories with spawning. Same as TPMBM but with Poisson
%intensity equal to zero (with an improvement for how Murty is done for
%this case) 
...
filter_upd.tree_index=tree_index_prev;
filter_upd.N_tree=N_tree_prev;
